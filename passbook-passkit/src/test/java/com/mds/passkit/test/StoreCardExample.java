...
public class StoreCardExample {
	...
	public static void main(String[] args) throws Throwable {
		Pass pass = new Pass()
			.teamIdentifier("CYZAN6D7LX")
			.webServiceURL("http://172.20.10.2:8080/")
			.authenticationToken("test1231111111sfhfsdkjahsdssdfdsfd")
			.passTypeIdentifier("pass.com.mds.passbookapitestnext")
		...
		PassSigner signer = PassSignerImpl.builder()
			.keystore(new FileInputStream("files/Certificates.p12"),"passbookapitestnext", "passbookapitestnext")
		 
			.intermediateCertificate(new FileInputStream("files/AppleWWDRCA.cer"))
			.build();

		PassSerializer.writePkPassArchive(pass, signer, new FileOutputStream("/Users/adityasrivastava/Desktop/StoreCardFile123.pkpass"));
	}
